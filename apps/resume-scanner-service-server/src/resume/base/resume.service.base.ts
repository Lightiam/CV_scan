...
export class ResumeServiceBase {
  ...
  async GenerateFormattedResume(args: Resume): Promise<Resume> {
  ...
  async MatchResumeWithJobDescription(args: Resume): Promise<boolean> {
    throw new Error("Not implemented");
  }
  async ScoreResume(args: Resume): Promise<number> {
    throw new Error("Not implemented");
  }
  ...
  async SuggestAndAddSkills(args: Resume): Promise<Resume> {
    throw new Error("Not implemented");
  }
  async UploadResume(args: ResumeCreateInput): Promise<Resume> {
    throw new Error("Not implemented");
  }
}
