...
export class ResumeResolverBase {
  ...
  async GenerateFormattedResume(
    ...
    return this.service.GenerateFormattedResume(args);
  }

  @graphql.Query(() => [ChatMessageUpdateManyWithoutResumesInput])
  async GetChatMessages(
    @graphql.Args()
    args: Resume
  ): Promise<ChatMessageUpdateManyWithoutResumesInput[]> {
    return this.service.GetChatMessages(args);
  }
  ...
  async MatchResumeWithJobDescription(
    ...
    return this.service.MatchResumeWithJobDescription(args);
  }
  ...
  async ScoreResume(
    ...
    return this.service.ScoreResume(args);
  }

  @graphql.Mutation(() => ChatMessageUpdateManyWithoutResumesInput)
  async SendChatMessage(
    @graphql.Args()
    args: ChatMessageCreateNestedManyWithoutResumesInput
  ): Promise<ChatMessageUpdateManyWithoutResumesInput> {
    return this.service.SendChatMessage(args);
  }
  ...
  async SuggestAndAddSkills(
    ...
    return this.service.SuggestAndAddSkills(args);
  }

  @graphql.Mutation(() => Resume)
  async UploadResume(
    @graphql.Args()
    args: ResumeCreateInput
  ): Promise<Resume> {
