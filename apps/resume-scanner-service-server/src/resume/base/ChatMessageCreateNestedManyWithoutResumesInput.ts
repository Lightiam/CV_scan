...
@InputType()
class ChatMessageCreateNestedManyWithoutResumesInput {
...
export { ChatMessageCreateNestedManyWithoutResumesInput as ChatMessageCreateNestedManyWithoutResumesInput };
